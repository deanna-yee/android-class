...
* Deanna Yee
* CIS 135 OL
* File Name: FragmentAddNote.java
* File Description: contains the class definition to add notes
* Assignment #: 8
* Date: 5/11/17
*/
...
public class FragmentAddNote extends android.app.Fragment implements
